...
**How good were our output synergy predictions?**
...
```{r roc-res, class.source = 'fold-show', fig.width=5, fig.height=5, dpi=300, cache=TRUE, fig.cap='ROC curve (CASCADE 1.0, HSA synergy method, 150 models calibrated to the AGS steady state)', fig.align='center'}
...
```{r pr-res, class.source = 'fold-show', fig.width=5, fig.height=5, dpi=300, cache=TRUE, fig.cap='PR curve (CASCADE 1.0, HSA synergy method, 150 models calibrated to the AGS steady state)', fig.align='center'}
