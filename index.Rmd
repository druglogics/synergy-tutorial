...
```{r roc-res, fig.align='center', fig.width=5, fig.height=5, dpi=300, fig.cap='ROC curve (CASCADE 1.0, HSA synergy method, 150 models calibrated to the AGS steady state)', class.source = 'fold-show'}
...
```{r pr-res, fig.align='center', fig.width=5, fig.height=5, dpi=300, fig.cap='PR curve (CASCADE 1.0, HSA synergy method, 150 models calibrated to the AGS steady state)', class.source = 'fold-show'}
